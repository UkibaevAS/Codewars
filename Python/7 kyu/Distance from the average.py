"""
Given a starting list/array of data, it could make some statistical sense to know how much each value differs
from the average.
...
rounding each difference to the second decimal digit (this is not needed in Haskell); extra points
...
def distances_from_average(test_list):
    ...
    return [round(average - i, 2) for i in test_list]