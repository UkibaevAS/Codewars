...
Though spoonerisms are about letters in words in the domain of written and spoken language, numbers are
included in the inputs for the random test cases and they require no special treatment.
...
def spoonerize(words):
    text = words.split()
    text[0], text[-1]= text[-1][0] + text[0][1:], text[0][0] + text[-1][1:]
    return " ".join(text)